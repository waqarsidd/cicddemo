...
@Component({
  selector: 'app-account-jobs',
  templateUrl: './account-jobs.component.html',
  styleUrls: ['./account-jobs.component.scss']
})
export class AccountJobsComponent  {

  public totalRecords: number;
  public isReqPending: boolean;
  public globalFilterFields = ACCOUNT_JOBS.filter(({ filter }) => filter);
  public searchControl: FormControl = new FormControl('');
  public searchedOptions: Array<any> = [];
  public columns: Array<IFormField> = ACCOUNT_JOBS.filter(({ read }) => read);
