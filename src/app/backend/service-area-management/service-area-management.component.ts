...
import { SERVICE_AREAS_FIELDS } from '@app/CONSTANT/service-areas-fields';
...
export class ServiceAreaManagementComponent {
  public totalRecords: number;
  public isReqPending: boolean;
  public globalFilterFields = SERVICE_AREAS_FIELDS.filter(
    ({ filter }) => filter
  );
  public searchControl: FormControl = new FormControl('');
  public searchedOptions: Array<any> = [];
  public columns: Array<IFormField> = SERVICE_AREAS_FIELDS;
