...
@Component({
  selector: 'app-suspensions-management',
  templateUrl: './suspensions-management.component.html',
  styleUrls: ['./suspensions-management.component.css']
})
export class SuspensionsManagementComponent  {
